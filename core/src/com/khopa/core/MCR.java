...
/**
 *
 * Main Class Base for Khopa LibGDX based Engine
 *
 * @author Clément Perreau
 *
 */
public abstract class MCR extends ApplicationAdapter {

    /**
     * Engine Instance
     */
    private static MCR instance;
    ...
    public MCR(ActionResolver resolver){
    ...
    public void initializeService(){
        ...
        new ConfigurationServiceImpl(); // Configuration
